...
public class BlockSided extends BlockDelta
{
     ...
     {
          this.blockIcon = doRegister(this.name + "_back", register);
          this.frontIcon = doRegister(this.name + "_front", register);
          this.sideIcon = doRegister(this.name + "_side", register);
     }
