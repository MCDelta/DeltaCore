...
final class Handler
{
    ...
    public void init()
    {
        ...
        if (Loader.isModLoaded(name))
        {
            ...
            {
                Logger.severe(e, String.format("MC Delta has failed to find a compatibility class with %s, please inform the CCM Team", name));
                return;
            }
            try
            {
            ...
            {
                Logger.severe(e, String.format("MC Delta has failed to create a new instance of a compatibility with %s, please inform the CCM Team", name));
                return;
            }
            try
            {
            ...
            {
                Logger.severe(e, String.format("MC Delta has failed to load a compatibility with %s, please inform the CCM Team", name));
                return;
            }
        }
    }
