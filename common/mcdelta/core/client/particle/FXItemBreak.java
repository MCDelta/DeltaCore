...
public class FXItemBreak extends EntityFX
{
    ...
    public FXItemBreak(final World world, final double x, final double y, final double z, final double motionX, final double motionY, final double motionZ, final ItemStack item,
            final int damage)
    {
