...
public class ParticleCriticalHit extends EntityFX
{
    ...
    public ParticleCriticalHit(final World world, final Entity target, final double x, final double y, final double z, final float r, final float g, final float b,
            final int maxLife, final int ppt, final boolean magic)
    {
        super(world, x, y, z);
