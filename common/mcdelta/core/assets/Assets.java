...
public class Assets
{
     ...
     public static boolean rescourceExists (ResourceLocation loc)
     {
          boolean b = false;
     ...
     public static void spawnParticle (int particle, World world, double x, double y, double z, Object... obj)
     {
          ...
          {
               PacketDispatcher.sendPacketToAllAround(x, y, z, 10, world.provider.dimensionId, populatePacket(new PacketSpawnParticle(particle, x, y, z)));
          }
     }
}
