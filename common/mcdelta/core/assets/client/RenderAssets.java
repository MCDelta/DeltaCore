...
public class RenderAssets
{
    ...
    public static void renderEquippedItem(final ItemStack stack, final TextureManager texturemanager, final int passes, final Icon[] icons, final int[] colors,
            final boolean[] shiny)
    {
        for (int i = 0; i < passes; i++)
        {
    ...
    public static void renderItemInventory(final ItemStack stack, final TextureManager engine, final int passes, final Icon[] icons, final int[] colors, final boolean[] shiny,
            final int zLevel)
    {
        stack.getItemDamage();
    ...
    private static void renderDroppedItem(final EntityItem entityItem, final ItemStack stack, Icon icon, final int par3, final float par4, final float par5, final float par6,
            final float par7, final int pass, final boolean shiny)
    {
