...
public class ItemDeltaArmor extends ItemArmor implements IExtraPasses
{
     ...
     public ItemDeltaArmor (EnumMCDMods m, ToolMaterial mat, int i)
     {
          ...
          this.mod = m;
          this.name = getArmorType(i) + "." + mat.getName().toLowerCase();
          String unlocalized = mod.modid.toLowerCase() + ":" + name;
          this.setUnlocalizedName(unlocalized);
          this.setCreativeTab(CreativeTabs.tabCombat);
          
          this.toolMaterial = mat;
          this.damageReduceAmount = mat.getDamageReductionAmount(i);
          this.setMaxDamage(mat.getDurability(i));
     ...
     public void registerIcons (IconRegister register)
     {
          ...
          this.itemIcon = ItemDelta.doRegister("deltacore", "armor_" + armorType, register);
     }
