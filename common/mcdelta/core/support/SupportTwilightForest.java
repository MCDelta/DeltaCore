...
public class SupportTwilightForest implements LimitedModSupport
{
     ...
     public void preInit ()
     {
          ...
          FIERY = MaterialRegistry.add(new DeltaInfo("fiery", 3941155, "ingotFiery", false, true, false, false), new ToolInfo(4, 1024, 9.0F, 4.0F, 10), null, new ExtraInfo(EnumChatFormatting.LIGHT_PURPLE, new SimpleEntry<Enchantment, Integer>(Enchantment.fireAspect, 1), null, new SimpleEntry<String, Integer>("blazeRod", 16501540)));
