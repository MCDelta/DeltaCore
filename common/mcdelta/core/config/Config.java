...
public class Config
{
     private Map<String, Configuration> stringToCfg = new HashMap();
     private Map<Configuration, String> cfgToString = new HashMap();
     public String                      filePath;
     
     private String                     core        = "core";
     private String                     items       = "items";
     private String                     blocks      = "blocks";
     private String                     enchants    = "enchants";
     ...
     private void initCore (Configuration cfg)
     {
          ...
          try
          {
               ...
               cfg.addCustomCategoryComment(Settings.CATEGORY_LOG, buildFancyComment(Settings.COMMENT_LOG, cfg.NEW_LINE, 20));
               cfg.addCustomCategoryComment(Settings.CATEGORY_MISC, buildFancyComment(Settings.COMMENT_MISC, cfg.NEW_LINE, 20));
          }
          catch (Exception e)
          {
               e.printStackTrace();
     ...
     public void getBoolean (Class clazz, Configuration cfg, Field field, String category) throws Exception
     {
     ...
     public void getInteger (Class clazz, Configuration cfg, Field field, String category) throws Exception
     {
     ...
     public void formatFile (Configuration cfg, String descrip)
     {
          ...
          if (file.canRead() && file.canWrite())
          {
               try
               {
                    ...
                    "# MCDelta " + Assets.capitalize(getConfigName(cfg)) + " Config File" + cfg.NEW_LINE + "#===================" + cfg.NEW_LINE + buildFancyComment("# " + descrip, cfg.NEW_LINE + "# ", 30) + cfg.NEW_LINE
                    
                    );
                    
                    s += cfg.NEW_LINE + "# " + dateFormat.format(date);
                    writer.write(s);
     ...
     private String getTitle (Class clazz, String s) throws Exception
     {
