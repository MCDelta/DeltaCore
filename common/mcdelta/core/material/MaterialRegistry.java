...
public final class MaterialRegistry
{
    ...
    public static ItemMaterial add(final ModDelta owner, final String name, final int color, final String oreName, final EnumToolMaterial tool, final int uses,
            final EnumArmorMaterial armor)
    {
    ...
    public static ItemMaterial add(final ModDelta owner, final String name, final int color, final String oreName, final boolean needTool, final boolean needWeapon,
            final EnumToolMaterial tool, final int uses, final EnumArmorMaterial armor)
    {
        return add(owner, new Object[]
    ...
    public static ItemMaterial add(final ModDelta owner, final Object[] delta, final EnumToolMaterial tool, final int uses, final EnumArmorMaterial armor)
    {
        return add(
                ...
                delta,
                new Object[]
                { tool.getHarvestLevel(), tool.getMaxUses(), tool.getEfficiencyOnProperMaterial(), tool.getDamageVsEntity(), tool.getEnchantability() },
                new Object[]
                { uses, new int[]
                { armor.getDamageReductionAmount(0), armor.getDamageReductionAmount(1), armor.getDamageReductionAmount(2), armor.getDamageReductionAmount(3) },
                        armor.getEnchantability() }, null, null);
    }
    ...
    public static ItemMaterial add(final ModDelta owner, final Object[] delta, final Object[] tool, final Object[] armor, EnumToolMaterial toolMat, EnumArmorMaterial armorMat)
    {
        ItemMaterial tmp = new ItemMaterial(owner, delta, tool, armor, toolMat, armorMat);
        mats.add(tmp);
