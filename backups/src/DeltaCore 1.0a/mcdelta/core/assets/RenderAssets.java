...
public class RenderAssets
{
     ...
     public static void renderEntityItem (EntityItem entityItem, ItemStack stack, int passes, Icon[] icons, int[] colors)
     {
          ...
          for (int i = 0; i < passes; i++)
          {
               ...
               renderDroppedItem(entityItem, stack, icon, b0, 0, r, g, b, 0);
          }
     }
     ...
     public static void renderItemInWorld (ItemStack stack, TextureManager texturemanager, int passes, Icon[] icons, int[] colors)
     {
          for (int i = 0; i < passes; i++)
          {
               Icon icon = icons[i];
               ...
               renderDroppedItem(null, stack, icon, 0, 0, r, g, b, 0);
          }
     ...
     public static void renderEquippedItem (ItemStack stack, TextureManager texturemanager, int passes, Icon[] icons, int[] colors)
     {
          for (int i = 0; i < passes; i++)
          {
               Icon icon = icons[i];
     ...
     {
          renderItemInventory(stack, engine, 1, new Icon[] {stack.getIconIndex()}, new int[] {0xffffff}, zLevel);
     }
     
     
     
     
     public static void renderItemInventory (ItemStack stack, TextureManager engine, int passes, Icon[] icons, int[] colors, int zLevel)
     {
          int k = stack.itemID;
     ...
     private static void renderDroppedItem (EntityItem entityItem, ItemStack stack, Icon icon, int par3, float par4, float par5, float par6, float par7, int pass)
     {
